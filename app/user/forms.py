...
class AjoutUserForm(FlaskForm):
    ...
    boutique_users= QuerySelectField(query_factory=rech_boutique, get_label='nom_boutique', allow_blank=True)
    ...
    depot_users= QuerySelectField(query_factory=rech_depot, get_label='nom_depot', allow_blank=True)
